...
package com.distriqt.test.linesdk
{
	...
	public class Main extends Sprite implements ILogger
	{
		...
		private var _tests		: LineSDKTests;
		...
		private function createUI():void
		{
			...
			_tests = new LineSDKTests( this );

			
			addAction( "Initialise", _tests.initialiseSDK );
			
			addAction( "Login", _tests.startLogin );
			addAction( "Get Profile", _tests.getProfile );
			addAction( "Logout", _tests.logout );
			
			addAction( "Get Access Token", _tests.getAccessToken );
			addAction( "Refresh Access Token", _tests.refreshAccessToken );
			addAction( "Verify Access Token", _tests.verifyAccessToken );
